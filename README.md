# Implementation details {#app:appendix_a}
...
tool](img/techdesign_schematic.png){#fig:app_techdesign_schematic}
...
## Implementation of system and benchmarks {#sec:app_implementation_system_benchmarks}

As described in , two target platforms are used for running the
...
## Experimental setup {#sec:app_experimental_setup}
...
### Experiments definition {#sec:app_experiments_definition}
...
## Data processing {#sec:app_data_processing}
...
### Description of data processing scripts {#sec:app_description_data_processing_scripts}
